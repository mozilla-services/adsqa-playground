...
def main():
    ...
    file_path = "source-data-mobile/overview.txt"
    ...
    if latest_commit:
        ...
        save_content_to_file(latest_content, "mob_latest.txt")
    ...
    if previous_commit:
        ...
        save_content_to_file(previous_content, "mob_previous.txt")
...
if __name__ == "__main__":
    oldfile = "mob_previous.txt"
    newfile = "mob_latest.txt"
    output_file = "mob_differences.txt"
